...
The learning rate is usually set when designing a model. However, hardcoding this would result in the same constant value for all variables, regardless of the values of the respective gradients. This can cause uneven updates, resulting in slow convergence or oscillation.
...
<p align="center">
  <img src="/assets/img/2025-10-19-gdo/lr.png" width="80%" height="80%">
</p>
...
<p align="center">
  <img src="/assets/img/2025-10-19-gdo/saddle.gif" width="80%" height="80%">
 </p>
<p align="center"><b><i>SGD and SGD with Momentum</i></b></p>
