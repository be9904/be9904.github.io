...
교육 커리큘럼은 학기 중에 진행되며, 유니티(Unity)의 기초를 배우는 것으로 시작합니다. 이후 간단한 3D 게임을 제작하는 과제를 수행하여 피드백을 받게 됩니다.
두 번째 과제로 오큘러스 퀘스트 2를 이용하여 VR 개발의 기본을 배우게 됩니다. 4기부터 AR 관련 내용도 추가되어서 더 다양한 XR 기술을 배울 수 있게 되었습니다.
